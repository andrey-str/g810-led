...
public:
    ...
    enum class PowerOnEffect {
        rainbow, color
    };
    enum class KeyAddressGroup {
        logo, indicators, multimedia, keys
    };
    ...
    enum class KeyGroup {
        logo, indicators, multimedia, fkeys, modifiers, arrows, numeric, functions, keys
    };
    ...
    bool attach(unsigned short lg_pid);
